...
if __name__=='__main__':
    ...
    #
    # x=np.arange(0,1,1/500)
    # x2=np.arange(0.1,0.6,1/500)
    # x=np.concatenate((x,x2))
    # xP=np.sort(x)
    # end=len(xP)
    # end=np.random.randint(int(len(xP)*0.5),len(xP))
    #
    # y,derive=DE(xP,t1=10,t2=-10)
    # xD=xP[:end]
    # yD=y[:end]
    # derive1=derive[:end]
    #
    ...
    # var=varModel(derive)
    # var1=var[:end]
    # x2,noise=addNoise(xD,yD,var1,typeN="Gaussion")
    # plt.plot(x2,noise,'.',color='black')
    # x2,noise=addNoise(xD,yD,var1,typeN="zero")
    # plt.plot(x2,noise,'.',color='black')
    # x2,noise=addNoise(xD,yD,var1,typeN="stacked")
    # plt.plot(x2,noise,'.',color='black')
    # x2,noise=addNoise(xD,yD,var1,typeN="random")
    # plt.plot(x2,noise,'.',color='black')
    #
    # var2=var[end:]
    ...
    # plt.xlim((0,1))
    # plt.ylim((0,1))
    # plt.plot(xP,y,color='black',linewidth=3)
    # plt.axis('off')
    # plt.show()
    # # np.reshape
    #
